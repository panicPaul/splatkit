...
Native 3DGRT-family backends for `ember-core`.
...
The implementation folders under `src/ember_native_3dgrt/` include short
...
`src/ember_native_3dgrt/core/native/stoch3dgs/dependencies/optix-dev/` are
