...
from ember_core.core.contracts import GaussianScene2D, GaussianScene3D
from ember_core.core.registry import register_backend

from ember_adapter_backends.gsplat.renderer_2d import render_gsplat_2dgs
from ember_adapter_backends.gsplat.renderer_3d import render_gsplat
...
def register() -> None:
    """Register the gsplat backends in the global ember-core registry."""
    register_backend(
        name="adapter.gsplat",
