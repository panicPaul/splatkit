"""Depth-aware render custom ops for the FasterGS native proof backend."""
...
from splatkit_native_backends.faster_gs_depth.runtime.blend import (
    _blend_bwd_fake,
    _blend_fwd_fake,
    blend_bwd_op,
    blend_fwd_op,
)
from splatkit_native_backends.faster_gs_depth.runtime.packing import (
    make_render_result,
    pack_render_outputs,
...
from splatkit_native_backends.faster_gs.reuse.factories import (
    register_render_family,
)
from splatkit_native_backends.faster_gs.runtime.ops._common import (
    requires_grad,
)
from splatkit_native_backends.faster_gs.runtime.ops.preprocess import (
    _preprocess_bwd_fake,
    _preprocess_fwd_fake,
)
from splatkit_native_backends.faster_gs.runtime.ops.sort import (
    _sort_fwd_fake,
)
...
@torch.library.custom_op("faster_gs_depth::render_fwd", mutates_args=())
def render_fwd_op(
    ...
    """Low-level composed depth-aware render forward op."""
...
@torch.library.custom_op("faster_gs_depth::render_bwd", mutates_args=())
def render_bwd_op(
    center_positions: Tensor,
    log_scales: Tensor,
    unnormalized_rotations: Tensor,
    ...
    """Low-level composed depth-aware render backward op."""
    (
...
def _render_impl(
    ...
    """Autograd-enabled full depth-aware render op."""
...
def _render_fake(*args: Any) -> RenderOpOutput:
    """Fake implementation for the autograd depth-aware render op."""
...
def _render_setup_context(
    ...
    ctx.save_for_backward(
        ...
        render_result.preprocess.primitive_depth,
        ...
        render_result.blend.bucket_depth_prefix,
    )
    ctx.width = inputs[10]
...
render_op = register_render_family(
    op_name="faster_gs_depth::render",
...
def render(*args: Any, **kwargs: Any) -> Any:
    """Run the depth-aware render op and return a typed result."""
