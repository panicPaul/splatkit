...
from splatkit_native_backends.faster_gs_depth_native.reuse import (
...
from splatkit_native_backends.gaussian_pop_native.runtime._extension import (
    load_extension,
)
...
@torch.library.custom_op("gaussian_pop_native::blend_fwd", mutates_args=())
def blend_fwd_op(
...
blend_op = register_blend_family(
    op_name="gaussian_pop_native::blend",
