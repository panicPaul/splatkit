...
namespace ember_core::faster_gs_depth_native {
...
depth_blend_fwd_wrapper(
    ...
    ember_core::faster_gs_native::check_cuda_int_tensor(
    ...
    ember_core::faster_gs_native::check_cuda_int_tensor(bucket_count, "bucket_count");
    ember_core::faster_gs_native::check_cuda_float_tensor(
        projected_means,
        "projected_means"
    );
    ember_core::faster_gs_native::check_cuda_float_tensor(
    ...
    ember_core::faster_gs_native::check_cuda_float_tensor(colors_rgb, "colors_rgb");
    ember_core::faster_gs_native::check_cuda_float_tensor(
        primitive_depth,
        "primitive_depth"
    );
    ember_core::faster_gs_native::check_cuda_float_tensor(bg_color, "bg_color");
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> depth_blend_bwd_wrapper(
    ...
    ember_core::faster_gs_native::check_cuda_float_tensor(grad_depth, "grad_depth");
    ember_core::faster_gs_native::check_cuda_float_tensor(depth, "depth");
    ember_core::faster_gs_native::check_cuda_int_tensor(
        instance_primitive_indices,
        "instance_primitive_indices"
    );
    ...
    torch::Tensor grad_conic_helper = ember_core::faster_gs_native::get_cached_workspace(
        "depth_blend_grad_conic_helper",
        float_options,
        3LL * n_primitives
    ).view({3, n_primitives});
    torch::Tensor grad_opacity = ember_core::faster_gs_native::get_cached_workspace(
