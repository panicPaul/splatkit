"""Combined render custom ops for the FasterGS Mojo runtime."""
...
from ember_native_faster_gs_mojo.core.runtime.ops.sort import (
    _sort_fwd_fake,
    sort_fwd_op,
)
...
@torch.library.custom_op("faster_gs_mojo::render_bwd", mutates_args=())
def render_bwd_op(
    center_positions: Tensor,
    log_scales: Tensor,
    unnormalized_rotations: Tensor,
