...
from splatkit_native_backends.faster_gs_depth_native.runtime.blend import (
    _blend_bwd_fake,
    _blend_fwd_fake,
    blend_bwd_op,
    blend_fwd_op,
)
from splatkit_native_backends.faster_gs_depth_native.runtime.packing import (
    make_render_result,
    pack_render_outputs,
...
@torch.library.custom_op("faster_gs_depth_native::render_fwd", mutates_args=())
def render_fwd_op(
...
@torch.library.custom_op("faster_gs_depth_native::render_bwd", mutates_args=())
def render_bwd_op(
    center_positions: Tensor,
    log_scales: Tensor,
    unnormalized_rotations: Tensor,
...
render_op = register_render_family(
    op_name="faster_gs_depth_native::render",
