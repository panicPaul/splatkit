...
from splatkit_native_3dgrt.core.runtime.ops._common import (
    tracer_wrapper,
)


@torch.library.custom_op("core::trace_fwd", mutates_args=())
def trace_fwd_op(
    state_token: Tensor,
    ray_to_world: Tensor,
    ray_ori: Tensor,
...
@torch.library.custom_op("core::trace_bwd", mutates_args=())
def trace_bwd_op(
    state_token: Tensor,
