...
from splatkit_native_3dgrt.core.runtime.state import (
    build_or_update_acc,
    destroy_state_token,
)


@torch.library.custom_op("core::build_acc", mutates_args=())
def build_acc_op(
    state_token: Tensor,
...
@torch.library.custom_op("core::update_acc", mutates_args=())
def update_acc_op(
    state_token: Tensor,
    particle_density: Tensor,
) -> tuple[Tensor]:
...
@torch.library.custom_op("core::destroy_acc", mutates_args=())
