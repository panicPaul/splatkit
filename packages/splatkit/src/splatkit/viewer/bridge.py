...
def camera_to_viewer_payload(
    ...
    *,
    ...
    """Convert a batched splatkit camera to a single-camera viewer payload."""
...
def camera_from_viewer_payload(
    ...
    """Convert a viewer payload back into a batched splatkit camera."""
    return CameraState(
...
def launch_viewer(
    ...
    *,
    ...
    """Launch the configured viewer backend using splatkit camera states."""
    import marimo as mo
