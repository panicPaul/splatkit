...
from splatkit_native_backends.faster_gs_depth_native.runtime._extension import (
    load_extension,
)
...
@torch.library.custom_op("faster_gs_depth_native::blend_fwd", mutates_args=())
def blend_fwd_op(
...
@torch.library.custom_op("faster_gs_depth_native::blend_bwd", mutates_args=())
def blend_bwd_op(
    grad_image: Tensor,
    grad_depth: Tensor,
    image: Tensor,
...
blend_op = register_blend_family(
    op_name="faster_gs_depth_native::blend",
