...
#include "../../faster_gs/native/rasterization/include/kernels_forward.cuh"
...
namespace shared_forward_kernels = ember_faster_gs_core_vendor::rasterization::kernels::forward;
namespace fastgs_forward_kernels = ember_fastgs::rasterization::kernels::forward;
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, int> run_sort_impl(
    ...
    CHECK_CUDA(config::debug, "fastgs_create_instances")
    ...
    torch::Tensor sort_workspace = get_cached_workspace(
        "fastgs_instance_sort_workspace",
    ...
    CHECK_CUDA(config::debug, "fastgs_sort_instances")
    ...
    shared_forward_kernels::extract_instance_ranges_cu<KeyT>
    ...
    CHECK_CUDA(config::debug, "fastgs_extract_instance_ranges")

    torch::Tensor tile_num_buckets = get_cached_workspace(
        "fastgs_tile_num_buckets",
        int_options,
        tile_count
    );
    shared_forward_kernels::extract_bucket_counts
    ...
    CHECK_CUDA(config::debug, "fastgs_extract_bucket_counts")
    ...
    CHECK_CUDA(config::debug, "fastgs_scan_bucket_counts")
...
sort_fwd_wrapper(
    ...
    CHECK_CUDA(config::debug, "fastgs_sort_depth")
    ...
    torch::Tensor primitive_offsets = get_cached_workspace(
        "fastgs_primitive_offsets",
        int_options,
        n_visible
    );
    torch::Tensor num_touched_tiles_c = num_touched_tiles.contiguous();
    shared_forward_kernels::apply_depth_ordering_cu
    ...
    CHECK_CUDA(config::debug, "fastgs_apply_depth_ordering")
    ...
    CHECK_CUDA(config::debug, "fastgs_scan_offsets")
