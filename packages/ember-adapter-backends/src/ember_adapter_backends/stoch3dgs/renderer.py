"""Thin ember-core adapter for the stochastic 3DGRT renderer."""
...
def _import_stoch_runtime() -> tuple[type[Any], type[Any]]:
    try:
        ...
        raise ImportError(
            ...
            'Install it with `pip install "ember-adapter-backends[stoch3dgs]"`.'
        ) from exc
...
def register() -> None:
    """Register the Stoch3DGS backend in the global ember-core registry."""
    register_backend(
